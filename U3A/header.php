               ...
               <?php if ( leadengine_get_option( 'tek-logo-style' ) == '1') : ?>
                 ...
                 <a class="logo" href="<?php echo esc_url(home_url()); ?>">
                   <?php if ( isset( $primary_logo['url'] ) && '' != $primary_logo['url'] ) { ?>
                     <img class="fixed-logo" src="<?php echo esc_url( $primary_logo['url'] ); ?>" <?php if ( isset( $logo_size['width'] ) && '' != $logo_size['width']) { echo 'width="' . esc_attr( $logo_size['width'] ) .'"'; }?> alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" />

                     <?php if ( isset( $secondary_logo['url'] ) && '' != $secondary_logo['url'] ) { ?>
                     <img class="nav-logo" src="<?php echo esc_url( $secondary_logo['url'] ); ?>" <?php if ( isset( $logo_size['width'] ) && '' != $logo_size['width']) { echo 'width="' . esc_attr( $logo_size['width'] ) .'"'; }?> alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" />
                     <?php } ?>
